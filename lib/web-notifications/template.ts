...
export const WEB_NOTIFICATION_LABELS = [
  "<name>",
  "<first name>",
  "<email>",
  "<phone>",
...
export function buildWebRecipientTemplateContext(recipient: WebNotificationRecipient) {
...
export function personalizeWebNotificationTemplate(
  template: string,
  recipient: WebNotificationRecipient
) {
  let result = String(template || "");
  const context = buildWebRecipientTemplateContext(recipient);
